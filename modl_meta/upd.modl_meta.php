...
class Modl_meta_upd {
	...
	{				
		...
		if ($this->EE->db->table_exists('exp_seolite_content') AND $this->EE->db->table_exists('exp_seolite_config'))
		{
		   	...
		   	// Rename tables
		   	$this->dbforge->rename_table('exp_seolite_content', 'exp_modl_meta_content');
		   	$this->dbforge->rename_table('exp_seolite_config', 'exp_modl_meta_content');
			...
			$this->dbforge->modify_column('exp_seolite_content', $fields);
			...
			$this->dbforge->modify_column('exp_seolite_config', $fields);
		   	
		   	
		   	// Add fields for first release
	        ...
	        $this->EE->db->insert('modl_meta_config', array(
				'template' => "<title>{title}{site_name}</title>\n<meta name='keywords' content='{meta_keywords}' />\n<meta name='description' content='{meta_description}' />\n<link rel='canonical' href='{canonical_url}' />\n<!--Open Graph Tags-->\n<meta property=\"og:site_name\" content=\"{site_name}\"/>\n<meta property=\"og:url\" content=\"{canonical_url}\"/>\n{if meta_og_description}<meta property=\"og:description\" content=\"{meta_og_description}\"/>{/if}\n{if meta_og_image}<meta property=\"og:image\" content=\"{meta_og_image}\"/>
{/if}\n<!-- generated by modl_meta -->",
				...
				'default_og_image' => 'Absolute path to default Open Graph Image for site. Delete this text and leave blank if you would prefer not to provide one.'
	        ));	
		}
