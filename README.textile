...
|Template|This is the template that is added to your ExpressionEngine template where your MODL Meta tags are placed.|
|Default title postfix|This setting defines what should follow the default title value. We default to @ |&nbsp;@ as this will add spacing and a pipe between your default title and the site name for your page title.|
